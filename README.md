...
- **Pembuatan dokumen melalui Selesaikan diperbaiki**: Data Manager kini memakai nama file sementara yang tetap dikenali sebagai DOCX, sehingga pembuatan dokumen tidak lagi gagal dengan pesan `name 'messagebox' is not defined`.
- **Proses update diperjelas**: Status persiapan unduhan ditampilkan setelah koneksi ke installer berhasil dimulai agar launcher tidak menampilkan progres yang menyesatkan saat koneksi awal masih berlangsung.
